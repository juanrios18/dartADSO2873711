...
void main() {
  // JUAN PABLO RIOS ARISTIZABAL - EJE CONDICIONAL SIMPLE 01
  /*
  ...
  */
  ...
  //SALIDA ALGORITMO
  stdout.writeln("El nombre del empleado es: $nombre");
  stdout.write("El sueldo correspondiente del empleado es: $sueldo");
}
